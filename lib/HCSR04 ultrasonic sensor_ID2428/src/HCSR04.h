...
{
	public:
	void setup(int out,int echo);				//initialisation class HCSR04 (trig pin , echo pin)
	void setup(int out,int echo[],int n);		//initialisation class HCSR04 (trig pin , echo pin)
	~HCSR04();								//destructor
